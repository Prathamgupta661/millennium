  ...
  return (
    <section className="w-full overflow-hidden flex flex-col mt-20 relative font-playfair bg-white">
      ...
      <div className="mt-12 mx-auto w-[95%] max-w-8xl relative group">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/10 to-pink-400/10 rounded-2xl blur-[8px] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

        {/* Main Content Container */}
        <section className="relative flex flex-col md:flex-row shadow-xl rounded-2xl overflow-hidden bg-white/90 backdrop-blur-lg border border-gray-200">
          {/* Text Content */}
          ...
          {/* Visual/Illustration */}
          <div className="w-full md:w-1/2 flex items-center justify-center bg-gradient-to-br from-cyan-50 to-pink-50 py-10">
            <img
              src={img1}
              alt="MillenniumAi Services"
              className="w-72 h-72 sm:w-100 sm:h-100 object-contain rounded-xl hover:scale-105 transition-transform duration-500 bg-white/80 shadow"
              loading="lazy"
            />
          </div>
        </section>
